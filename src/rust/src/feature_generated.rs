...
impl<'a> Geometry<'a> {
    ...
    pub fn z(&self) -> Option<flatbuffers::Vector<'a, f64>> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f64>>>(Geometry::VT_Z, None)
    }
    #[inline]
    pub fn m(&self) -> Option<flatbuffers::Vector<'a, f64>> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f64>>>(Geometry::VT_M, None)
    }
    #[inline]
    pub fn t(&self) -> Option<flatbuffers::Vector<'a, f64>> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f64>>>(Geometry::VT_T, None)
    }
    #[inline]
...
pub fn size_prefixed_root_as_feature(
    buf: &[u8],
) -> Result<Feature, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_feature_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<Feature<'a>>,
) {
