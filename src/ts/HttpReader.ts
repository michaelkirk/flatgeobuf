...
import { Rect, calcTreeSize, DEFAULT_NODE_SIZE, NODE_ITEM_LEN, httpStreamSearch} from './packedrtree';
...
export class HttpReader {
    ...
    async* selectBbox(rect: Rect): AsyncGenerator<number[], void, unknown> {
        ...
        yield *httpStreamSearch(this.header.featuresCount, this.header.indexNodeSize, rect, readNode);
    }
